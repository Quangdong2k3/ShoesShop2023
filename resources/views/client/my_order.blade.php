...
<div class="colorlib-product" style="padding-top: 0;">
    <div class="container">
        ...
        <div class="row">
            @foreach($order_realate as $ol)
            <div class="col-md-3 col-lg-3 mb-4 text-center">
                <div class="product-entry border">
                    <a href="/detail-product/{{$ol->id}}" class="prod-img">
                        <img src="{{asset('public/image/'.$ol->avatar)}}" class="img-fluid" alt="Free html5 bootstrap 4 template">
                    </a>
                    <div class="desc">
                        <h2><a href="/detail-product/{{$ol->id}}">{{$ol->name}}</a></h2>
                        <span class="price">{{number_format($ol->price)}} VND</span>
                    </div>
                </div>
            </div>
            @endforeach
